...
<div class="row contentHeader">
	<div class="col-xs-12 polling PaddIngMargin">
		...
		<div class="col-xs-6 PaddIngMargin">
			...
			<button type="button" class="btn btn-primary btn_primary" data-toggle="modal" data-target="#upLoadFile" >上传文件</button>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog" style='top: calc(50% - 284px);'>
		<div class="modal-content addMymodal">
			...
			<div class="modal-body text-left">
					<form class="form-inline clearfix "  method="POST"  id="form1" enctype ="multipart/form-data" action="<%=basePath%>/business/importExcel">  
		...
		<div class="modal-content addMymodal">
			...
			<div class="modal-body text-left">
				<form class="row" id="addInfor">
					...
					<div class="col-xs-6 polling">
						<span class="textWidth">性   &nbsp; &nbsp; &nbsp;别: </span><select name="custSex" id="custSex1" class="form-control inputName select-header">
					...
					<div class="col-xs-6 polling">
						<span class="textWidth">证  &nbsp;件 &nbsp;号:</span><input type="text" class="form-control inputName" id="creditNo1" />
					</div>
					<div class="col-xs-6 polling">
					...
					<div class="col-xs-6 polling">
						<span class='textWidth'>出生日期：</span><input class="form-control inputName"  type="date" id="custBir1">
					</div>
				</form>
			</div>
			<div class="modal-footer modalHeaderButtom">
...
function checkDate(event) {
	...
	$('#form2')[0].action = "<%=basePath%>vip/exportExcel";
		$('#form2').submit();	
}
//上传文件功能
...
$('#upLoadFileBtnSubmit').on('click',function(event){
	...
	if(val){
		...
		$.ajax({
			url:'<%=basePath%>uploadExcel/upload',
            cache:false,
            type:"post",
            datatype:'json',
            contentType:false, 
